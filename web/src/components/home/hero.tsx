...
export function Hero({ stats }: HeroProps) {
  return (
    <section className="relative overflow-hidden py-18 md:py-20 min-h-[70vh] flex items-center">
      ...
      <div className="max-w-[1200px] mx-auto px-6 relative z-10 text-center">
        ...
        <h1 className="font-display text-[clamp(2.2rem,5vw,3.6rem)] font-black leading-[1.1] text-[#faf6ee] mt-5 mb-5">
          <span className="block">
            Vind Jouw <span className="text-[#e8b84b]">Studierichting</span>
          </span>
          <span className="block">in Suriname</span>
        </h1>
