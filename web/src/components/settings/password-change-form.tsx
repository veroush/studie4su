  ...
  return (
    <form onSubmit={handleSubmit} className="flex flex-col gap-2.5">
      <label className="flex flex-col gap-1.5">
        <span className="text-sm font-medium text-white">Huidig wachtwoord</span>
      ...
      <label className="flex flex-col gap-1.5">
        <span className="text-sm font-medium text-white">Nieuw wachtwoord</span>
        <input
          type={visible ? 'text' : 'password'}
          value={newPassword}
      ...
      <label className="flex flex-col gap-1.5">
        <span className="text-sm font-medium text-white">Bevestig nieuw wachtwoord</span>
        <input
          type={visible ? 'text' : 'password'}
