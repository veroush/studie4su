...
export function SchoolCard({
  ...
  return (
    <div className="group bg-white rounded-2xl overflow-hidden shadow-lg border border-transparent hover:border-[#e8b84b]/40 hover:-translate-y-2.5 hover:shadow-[0_24px_60px_rgba(0,0,0,0.25)] transition-all duration-300 flex flex-col">
      <div className="relative h-[180px] flex-shrink-0 overflow-hidden">
        {displayImage ? (
          <img
            ...
            alt=""
            onError={handleImageError}
            className="absolute inset-0 h-full w-full object-cover group-hover:scale-[1.07] transition-transform duration-500"
          />
        ) : (
          <div className="absolute inset-0 bg-gradient-to-br from-[#22c55e] to-[#15803d] group-hover:scale-[1.07] transition-transform duration-500" />
        )}
