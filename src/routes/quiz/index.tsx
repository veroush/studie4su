...
function QuizPage() {
  ...
  const pageShell = (content: React.ReactNode) => (
    <div className="min-h-screen flex flex-col">
      <Navbar />
      <div className="bg-gradient-to-br from-[#F3F4F6] via-[#eefbf3] to-[#fbecb8] flex-1 flex flex-col">
        <main
          className={`mx-auto w-full px-4 sm:px-6 flex-1 ${
            showResults ? 'max-w-[72rem] pt-12 pb-24' : 'max-w-[68rem] pt-6 pb-8'
          }`}
        >
          {content}
        </main>
